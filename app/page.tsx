...
import { getUserPick, getAllPicks, getAllUserPicks, getPicksStats } from "@/src/data";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 py-12 px-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-white/90">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                  ...
                  <span className="text-sm font-medium">Tap any card to reveal</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {!user.isAdmin && (
              <div className="mt-6 inline-flex items-center gap-6 bg-white/95 backdrop-blur-md px-8 py-4 rounded-2xl shadow-2xl border border-white/50">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-600 mt-1 uppercase tracking-wider">Total Cards</p>
                </div>
                <div className="w-px h-12 bg-gray-300" />
                <div className="text-center">
                  <p className="text-3xl font-bold text-green-600">{totalNumbers - takenNumbers.length}</p>
                  <p className="text-xs text-gray-600 mt-1 uppercase tracking-wider">Available</p>
                </div>
                <div className="w-px h-12 bg-gray-300" />
                <div className="text-center">
                  <p className="text-3xl font-bold text-orange-600">{takenNumbers.length}</p>
                  <p className="text-xs text-gray-600 mt-1 uppercase tracking-wider">Picked</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg className="w-full h-12 text-slate-50" preserveAspectRatio="none" viewBox="0 0 1440 54" fill="none">
            <path d="M0 22L60 17C120 12 240 2 360 0C480 -2 600 6 720 12C840 18 960 22 1080 20C1200 18 1320 10 1380 6L1440 2V54H1380C1320 54 1200 54 1080 54C960 54 840 54 720 54C600 54 480 54 360 54C240 54 120 54 60 54H0V22Z" fill="currentColor"/>
          </svg>
        </div>
      </div>
