    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-600">
          Manage your Esusu contribution system
        </p>
      </motion.div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-800">
                {paymentsToVerify.length} Payment{paymentsToVerify.length !== 1 ? "s" : ""} Awaiting Verification
              </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <p className="text-3xl font-bold text-gray-800">{stats.cycles.total}</p>
          <div className="mt-3 flex gap-3 text-xs">
            <span className="text-green-600">
              {stats.cycles.active} active
            </span>
